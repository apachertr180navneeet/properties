        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="app-brand justify-content-center mb-4">
                    <span class="app-brand-text demo text-body fw-bolder" style="font-size:1.75rem;">{{ config('app.name') }}</span>
                </div>
                <h4 class="mb-2 text-center">Welcome Back! 👋</h4>
                <p class="mb-4 text-center">Sign in to your admin account</p>
